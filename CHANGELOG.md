...
-   :building_construction: improve logo's svg.
...
-   :bug: fix `fileExists` issue.
-   :building_construction: change configurations to use a map instead.
...
-   :arrow_up: dependency upgrade.
-   :wrench: update ESLint rules with new `no-unsafe-argument` rule.
...
-   :arrow_up: dependency upgrade.
-   :wrench: remove concat warning (way more efficient with arrays).

## 4.5.0

-   :arrow_up: dependency upgrade.
-   :wrench: add a bunch of new rules and comments explaining every one.
